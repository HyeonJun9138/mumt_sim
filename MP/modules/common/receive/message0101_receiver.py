...
from nFusion.Model.msg_0101 import *            # C# 紐⑤뜽
from nFusion.Model.CommonType import *             # 怨듯넻 ???try:
    SystemOperationMode
except NameError:
    import importlib
...
class SystemOperationModeReceiver_0101(IFusionReceive[SystemOperationMode], IsLocal, IsSingletone):
    """0101 SystemOperationMode 硫붿떆吏 ?섏떊 由ъ떆踰?""
    ...
    def Receive(self, data: SystemOperationMode, src):
        try:
            ...
            print("[ERROR][Receive-0101] traceback ?볛넃??)
