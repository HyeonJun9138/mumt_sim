...
from nFusion.Model.msg_0402 import *       # C# 紐⑤뜽(?곗꽑)
...
# ??????????????????????????????????????????????????????????????????????????
# (?덇굅?쒖? ?명솚???꾪븳 TX/DB 洹쒖튃 - 0402???붿씠?몃━?ㅽ듃/DB 洹쒖튃 ?놁쓬)
TX_FIELD_WHITELIST = {
...
DB_DIR_RULES = {
    ...
    "0303": "UAVFlightPlan",   # ??push/receive 紐⑤몢 留욎땄
    "0304": "FlightPath",
}
...
# ??????????????????????????????????????????????????????????????????????????
# ?붾뱶?ъ씤??def make_and_push(body_dict: dict, node_messenger) -> bytes:
    """?뺤뀛?덈━瑜?C# 紐⑤뜽濡?蹂????Push"""
    # 0402???붿씠?몃━?ㅽ듃 ?곸슜 ????꾨떂 (?꾩껜 ?ㅽ궎留??꾩넚)
...
def make_random_and_push(node_messenger) -> bytes:
    """?쒕꼫?덉씠??湲곕컲 ?쒕뜡 硫붿떆吏 ?앹꽦 ???ㅽ뙣 ??理쒖냼 諛붾뵒濡??대갚"""
    try:
