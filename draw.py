...
from config import WIN_W, WIN_H, clamp
from dem import DEM, ray_intersect_dem
from uav import UAV
...
def draw_camera_footprint(uav, target, fov_diag_deg, dem: DEM, aspect_ratio=16 / 9, color=(0.1, 0.6, 1.0)):
