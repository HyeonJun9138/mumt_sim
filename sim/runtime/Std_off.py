...
from .autopilot import Mission, Waypoint
...
STANDOFF_MISSION_SPECS: Sequence[Tuple[Tuple[float, float, float], Tuple[float, float] | None, Tuple[float, float] | None]] = [
    ...
    ((20048.1, 14288.0, 710.0), (19643.4, 13257.6), (18993.7, 13950.6)),
    ((19960.2, 14205.6, 710.0), (19555.5, 13175.2), (18905.8, 13868.2)),
    ((19872.3, 14123.2, 710.0), (19467.6, 13092.7), (18817.9, 13785.8)),
    ((19784.4, 14040.8, 750.0), (19379.7, 13010.3), (18729.9, 13703.4)),
    ((19696.4, 13958.4, 750.0), (19291.8, 12927.9), (18642.0, 13621.0)),
